 ...
 * @param counter
 *            a counter
 * @param listSubRecords
 *            a list of plenty of sub records
 */
public record RecordDto(Integer counter, List<SubRecordDto> listSubRecords) {
	...
	public record SubRecordDto(Integer nbSomething, String code) {
		 ...
		 *
		 * @param subSubNbSomething
		 *            sub subnumber of something
		 * @param subSubCode
		 *            sub sub code for some reason
		 */
