...
cp openapi-maven-plugin/target/openapi-maven-plugin-${version}.jar release
cp openapi-maven-plugin/pom.xml release/openapi-maven-plugin-${version}.pom
cd release
...
pwd
ls -l
jar -cvf release-bundle-${version}.jar openapi-maven-plugin-${version}.pom openapi-maven-plugin-${version}.pom.md5 openapi-maven-plugin-${version}.pom.sha1 openapi-maven-plugin-${version}.jar openapi-maven-plugin-${version}.jar.md5 openapi-maven-plugin-${version}.jar.sha1
ls -l
